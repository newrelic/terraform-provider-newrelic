...
func TestAccNewRelicNrqlAlertCondition_StaticConditionPrediction(t *testing.T) {
	resourceName := "newrelic_nrql_alert_condition.foo"
	rName := acctest.RandString(5)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Test: Create
			{
				Config: testAccNewRelicNrqlAlertConditionStaticWithPrediction(
					rName,
					7200,
				),
				Check: resource.ComposeTestCheckFunc(
...
func TestAccNewRelicNrqlAlertCondition_StaticConditionDisableEventCreation(t *testing.T) {
	resourceName := "newrelic_nrql_alert_condition.foo"
	rName := acctest.RandString(5)
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Test: Create
			{
				Config: testAccNewRelicNrqlAlertConditionStaticWithDisableEventCreation(
					rName,
				),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckNewRelicNrqlAlertConditionExists(resourceName),
...
func testAccNewRelicNrqlAlertConditionStaticWithPrediction(
	name string,
	predictBy int,
) string {
	return fmt.Sprintf(`
...
func testAccNewRelicNrqlAlertConditionStaticWithDisableEventCreation(
	name string,
) string {
	return fmt.Sprintf(`
resource "newrelic_alert_policy" "foo" {
