...
func expandOrganizationCreateParams(d *schema.ResourceData) (string, *organization.OrganizationNewManagedAccountInput, *organization.OrganizationSharedAccountInput) {
	customerID := ""
	...
	return customerID, newManagedAccount, sharedAccount
}
