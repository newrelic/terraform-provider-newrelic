...
2. Run import command: 
   3. For Account Scope`terraform import newrelic_notification_destination.foo <destination_id>`
   4. For Organization  Scope`terraform import newrelic_notification_destination.foo <destination_id>:ORGANIZATION:<organization_id>`
