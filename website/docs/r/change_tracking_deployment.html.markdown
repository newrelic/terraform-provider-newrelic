...
Use this resource to create and manage New Relic change tracking deployment markers. Details regarding change tracking and deployment markers can be found [here](https://docs.newrelic.com/docs/change-tracking/change-tracking-introduction/).
...
* `validation_flags` - (Optional) Flags for validation. Valid values are `ALLOW_CUSTOM_CATEGORY_OR_TYPE`, `FAIL_ON_FIELD_LENGTH`, `FAIL_ON_REST_API_FAILURES`.
