...
Use this resource to create a deployment marker for change tracking in New Relic. Details regarding change tracking and deployments can be found [here](https://docs.newrelic.com/docs/change-tracking/change-tracking-introduction/).
