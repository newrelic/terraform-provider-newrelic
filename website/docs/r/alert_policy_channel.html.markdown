...
-> **Note - Not available in the JP region.** This resource depends on [`newrelic_alert_channel`](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/alert_channel), whose backing REST v2 endpoint is not provisioned on the New Relic Japan region, so `newrelic_alert_policy_channel` cannot be used on JP either. If your provider is configured with `region = "JP"`, a `terraform plan` will fail early with an actionable error message. For JP configurations, use [`newrelic_workflow`](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/workflow) together with [`newrelic_notification_destination`](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/notification_destination) and [`newrelic_notification_channel`](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/notification_channel) instead - all three work in every region.
