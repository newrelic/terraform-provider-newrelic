...
~> **DEPRECATED** Use at your own risk. Use the [`newrelic_entity`](/website/docs/providers/newrelic/d/entity.html) data source instead. This feature may be removed in the next major release.
