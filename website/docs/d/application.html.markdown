...
~> **DEPRECATED** Use at your own risk. Use the [`newrelic_entity`](../../docs/data-sources/entity) data source instead. This feature may be removed in the next major release.
