...
<b style="color:darkblue;">During the EOL window (before Aug 18, 2026 for Node browser runtime monitors; before Nov 18, 2026 for Node api runtime monitors):</b> The Synthetics API will continue to accept legacy runtime versions. However, we strongly recommend upgrading to the new runtime as soon as possible to ensure compatibility and avoid disruptions.

<b style="color:darkred;">After Aug 18, 2026 (Node browser runtime monitors) and Nov 18, 2026 (Node api runtime monitors):</b> The Synthetics API will reject any requests attempting to use legacy runtime values. Chrome-based monitors will be automatically force-upgraded to the latest runtime version (Chrome 147 or higher) on <b style="color:darkred;">Aug 18, 2026</b>, and API-based monitors will be force-upgraded to Node.js 22 on <b style="color:darkred;">Nov 18, 2026</b>.
...
- If your Terraform configuration for scripted monitors is **not updated** with new runtime values before the respective EOL dates (Aug 18, 2026 for Node browser runtime monitors; Nov 18, 2026 for Node api runtime monitors), the Synthetics API will force-upgrade these monitors to the latest runtime (Node browser runtime monitors on Aug 18, 2026; Node api runtime monitors on Nov 18, 2026). This will cause your Terraform state to drift.
...
|------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Simple Browser Monitor**   | Resource `newrelic_synthetics_monitor` with `type = "BROWSER"` (see [this page](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/synthetics_monitor#type))                          | `runtime_type = "CHROME_BROWSER"`, `runtime_type_version = "LATEST"`, `script_language = "JAVASCRIPT"` (see examples in the attached resource documentation). Chrome latest version is deployed automatically as new versions are released. On Aug 18, 2026, all monitors will be force upgraded to Chrome 147 or higher, which will also automatically upgrade to Node.js 22. |
...
| **Step Monitor**             | Resource `newrelic_synthetics_step_monitor` (see [this page](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/synthetics_step_monitor))                                             | `runtime_type = "CHROME_BROWSER"`, `runtime_type_version = "LATEST"` (see examples in the attached resource documentation). Chrome latest version is deployed automatically as new versions are released. On Aug 18, 2026, all monitors will be force upgraded to Chrome 147 or higher, which will also automatically upgrade to Node.js 22. |
| **Scripted API Monitor**     | Resource `newrelic_synthetics_script_monitor` used with type = `"SCRIPT_API"` (see [this page](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/synthetics_script_monitor#type))    | `runtime_type = "NODE_API"`, `runtime_type_version = "22.20.0"`, `script_language = "JAVASCRIPT"` (see examples in the attached resource documentation). On Nov 18, 2026, all monitors on Node.js 16 will be force upgraded to Node.js 22.                                                         |
| **Broken Links Monitor**     | Resource `newrelic_synthetics_broken_links_monitor` (see [this page](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/synthetics_cert_check_monitor))                               | `runtime_type = "NODE_API"`, `runtime_type_version = "22.20.0"` (see examples in the attached resource documentation). On Nov 18, 2026, all monitors on Node.js 16 will be force upgraded to Node.js 22.                                                                                           |
| **Cert Check Monitor**       | Resource `newrelic_synthetics_cert_check_monitor` (see [this page](https://registry.terraform.io/providers/newrelic/newrelic/latest/docs/resources/synthetics_cert_check_monitor))                                 | `runtime_type = "NODE_API"`, `runtime_type_version = "22.20.0"` (see examples in the attached resource documentation). On Nov 18, 2026, all monitors on Node.js 16 will be force upgraded to Node.js 22.                                                                                           |
