...
// Temporary: consumes https://github.com/newrelic/newrelic-client-go/pull/1487, which makes
// CloudAzureMonitorIntegrationInput.IncludeTags/ExcludeTags `*[]string` while keeping `omitempty`,
// so a nil pointer omits the field and a pointer to an empty slice sends `[]`. The `monitor`
// tag-clearing fix in this PR does nothing without it.
//
...
replace github.com/newrelic/newrelic-client-go/v2 => github.com/sgore-nr/newrelic-client-go/v2 v2.93.5-0.20260922050952-0135b01869b4
